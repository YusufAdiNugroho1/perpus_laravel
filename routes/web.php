...
Route::get('/rak_buku/edit_rak_buku/{id}','RakBukuController@edit');
Route::post('/rak_buku/update','RakBukuController@update');
...
Route::get('/pinjam/edit_pinjam/{id}','PinjamController@edit');
Route::post('/pinjam/update','PinjamController@update');
